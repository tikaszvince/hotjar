...
For a full description of the module, visit the project page: https://www.drupal.org/project/issues/2461325
To submit bug reports and feature suggestions, or to track changes: https://www.drupal.org/project/issues/2461325
...
CONFIGURATION
------------
Having installed the module, go to admin/config/system/hotjar page and fill the Hotjar ID field. 
What is my ID? This number is on your tracking code too, and it's on the url when you visit the site dashboard.

The default is set to "Add to every page except the listed pages". By default the following pages are listed for exclusion:
